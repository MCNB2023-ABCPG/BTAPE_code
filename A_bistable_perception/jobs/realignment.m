...
job{1}.spm.spatial.realign.estwrite.eoptions.quality = 0.95;
job{1}.spm.spatial.realign.estwrite.eoptions.sep = 1.5;
job{1}.spm.spatial.realign.estwrite.eoptions.fwhm = 1;
job{1}.spm.spatial.realign.estwrite.eoptions.rtm = 1;
...
%job{1}.spm.spatial.realign.estwrite.roptions.which = [1 1];
